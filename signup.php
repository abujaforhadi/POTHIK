...
<body>
    ...
    <div class="container">
        <div class="signup-form">
            <form method="post">
                <div class=" font-weight-bold pb-4 text-primary" style="font-size: 20px; text-align: center;">Sign Up
                </div>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input id="number" class="form-control" type="text" name="number" pattern="[01][0-9]{10}"
                                title="Start with 01" placeholder="Enter your phone number" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
