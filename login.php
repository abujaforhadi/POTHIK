            ...
            <div class="col-md-4">
                <div id="box">
                    <form method="post">
                        ...
                        <i class="fa-solid fa-user"></i> User name<input id="text" type="text" name="user_name" placeholder="" required><br><br>
                        <i class="fa-solid fa-lock"></i> Password <input id="text" type="password" name="password" placeholder="" required><br><br>
                        <div class="btn">
                            <a href="index.php">
                                <span></span>
                                <span></span>
