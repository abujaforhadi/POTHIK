...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2024 at 06:30 PM
...
('Jaflong', '2024-05-15', '', 2, 10, 10000, 'sy.jpg', 'Jaflong is one of beautiful place in Bangladesh,water &amp; stone looks very nice, i visited that place many times, last i visited 22 October 2022 with friend,that was excellent moments,i love jaflong and i wanna go again &amp; again'),
...
('Hanif Enterprise 9:30pm Non AC', 'Khagrachari', 'Dhaka', 750, 6),
...
('Hanif Enterprise 9:30pm Non AC', 'Dhaka', 'Khagrachari', 750, 6),
...
('Hanif Enterprise 9:30pm Non AC', 'Dhaka', 'CoxsBazar', 1100, 6),
('Hanif Enterprise 11:30pm Volvo AC', 'Dhaka', 'CoxsBazar', 1600, 26),
('Ena Transport (Pvt) Ltd 12:30pm Non AC', 'Dhaka', 'CoxsBazar', 1100, 17),
...
('Hanif Enterprise 9:30pm Non AC', 'CoxsBazar', 'Dhaka', 1100, 6),
('Hanif Enterprise 11:30pm Volvo AC', 'CoxsBazar', 'Dhaka', 1600, 26),
('Ena Transport (Pvt) Ltd 12:30pm Non AC', 'CoxsBazar', 'Dhaka', 1100, 17),
...
('Hanif Enterprise 9:30pm Non AC', 'Chittagong', 'Dhaka', 750, 5),
('Hanif Enterprise 11:30pm Volvo AC', 'Chittagong', 'Dhaka', 1200, 6),
('Ena Transport (Pvt) Ltd 12:30pm Non AC', 'Chittagong', 'Dhaka', 1000, 17),
...
('Hanif Enterprise 9:30pm Non AC', 'Chittagong', 'CoxsBazar', 350, 11),
...
('Hanif Enterprise 9:30pm Non AC', 'Rangpur', 'CoxsBazar', 1600, 11),
('Hanif Enterprise 8:30pm Non AC', 'Rangpur', 'Sylhet', 900, 25),
('Soudia Coach Service 8:30pm Volvo AC', 'Rangpur', 'Rajshahi', 250, 25),
('Hanif Enterprise 9:30pm Non AC', 'Rajshahi', 'CoxsBazar', 1700, 11),
...
('Hanif Enterprise 9:30pm Non AC', 'Rajshahi', 'Rangamati', 1700, 11),
...
('Saintmartin Travels 8:30pm Volvo AC', 'Khulna', 'Chittagong', 1600, 26),
('Ena Transport (Pvt) Ltd 7:30pm Non AC', 'CoxsBazar', 'Khulna', 1300, 20),
('Hanif Enterprise 9:30pm Non AC', 'Rangamati', 'CoxsBazar', 1600, 11),
...
('SR 8:30am Non AC', 'Bogura', 'Dhaka', 600, -2),
...
('SR 8:30am Non AC', 'Bogura', 'Dhaka', 700, -2),
...
('Hanif Enterprise 9:30pm Non AC', 'Rangamati', 'Bogura', 1600, 11),
...
INSERT INTO `product` (`tour_id`, `tour_Division`, `tour_name`, `Place_type`, `tour_price`, `tour_image`, `item_register`) VALUES
(1, 'Dhaka', 'Sonargaon', 'PicnicSpot', '750', './assets/products/d1.jpg', NULL),
(2, 'Dhaka', 'Lalbag', 'Historical', '700', './assets/products/d2.jpg', '2023-12-03'),
(3, 'Rajshahi', 'Behula Lakshindar Basor Ghor', 'Historical', '1300', './assets/products/r1.jpg', '2023-12-03'),
(4, 'Khulna', 'Sundarbans', 'Forest', '7000', './assets/products/k1.jpg', '2020-03-28'),
(5, 'Dhaka', 'Shahid Minar', 'Historical', '600', './assets/products/d3.jpg', '2022-12-17'),
(6, 'Dhaka', 'Jatiyo Sriti Shoudho', 'Historical', '500', './assets/products/d5.jpg', '2022-12-17'),
(7, 'Dhaka', 'Ahsan Manzil', 'Historical', '500', './assets/products/d4.jpg', '2022-12-17'),
(8, 'Chittagong', 'Cox\'s Bazar Beach', 'SeaBeach', '3500', './assets/products/c1.jpg', '2022-12-17'),
(9, 'Chittagong', 'Boga Lake', 'Hill', '2500', './assets/products/c3.jpg', '2022-09-09'),
(10, 'Chittagong', 'Nilachal', 'Hill', '3000', './assets/products/c4.jpg', '2020-03-28'),
(11, 'Chittagong', 'Saint Martin Island', 'SeaBeach', '6800', './assets/products/c2.jpg', '2020-03-28'),
(12, 'Rangpur', 'Kantajew Temple', 'Historical', '1800', './assets/products/ro1.jpg', '2023-01-03'),
(14, 'Chittagong', 'Sajek Valley', 'Hill', '3900', 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/09/bd/d1/fc/sajek.jpg?w=800&h=-1&s=1', '2022-12-17'),
(15, 'Rangpur', 'Ramsagar', 'PicnicSpot', '2100', './assets/products/ro2.jpg', '2023-01-03'),
(16, 'Chittagong', 'kaptai lake', 'Lake', '2700', './assets/products/c6.jpg', '2022-12-22'),
(17, 'Chittagong', 'Patenga Beach', 'SeaBeach', '2300', './assets/products/c7.jpg', '2022-12-17'),
(20, 'Rangpur', 'vinno jogot', 'PicnicSpot', '1900', './assets/products/ro3.jpg', '2022-12-17'),
(21, 'Rangpur', 'Shopnopuri', 'PicnicSpot', '1900', './assets/products/ro4.jpg', '2022-12-17'),
(22, 'Sylhet', 'Bisnakandi', 'Hill', '2350', './assets/products/s1.jpg', '2022-12-17'),
(23, 'Sylhet', 'Jaflong', 'Mountain', '2350', './assets/products/s2.jpg', '2022-12-17'),
(25, 'Sylhet', 'Ratargul Swamp Forest', 'Forest', '2750', './assets/products/s3.jpg', '2022-12-17'),
(26, 'Sylhet', 'Tanguar Haor', 'Lake', '2550', './assets/products/s4.jpg', '2022-12-17'),
(27, 'Rajshahi', 'Paharpur', 'Historical', '2600', './assets/products/r3.jpg', '2022-12-17'),
(28, 'Rajshahi', 'Tajhat Palace', 'PicnicSpot', '1960', './assets/products/r4.jpg', '2022-12-19'),
(30, 'Rajshahi', 'Mahasthangarh', 'Historical', '1390', './assets/products/r5.jpg', '2022-12-19'),
(31, 'Rajshahi', 'Pancharatna Gobinda Temple', 'Historical', '1700', './assets/products/r2.jpg', '2022-12-19'),
(32, 'Khulna', 'Shait-Gumbad Mosque', 'Historical', '2750', './assets/products/k2.jpg', '2022-12-09'),
(33, 'Khulna', 'Fakir Lalon Shah\'s Mazaar', 'Historical', '2950', './assets/products/k3.jpg', '2020-03-28'),
...
(5293, 'ismail', 'joy1@gmail.com', '@A1234567hf', '01310323085', 'Forest', 'West Shewrapara', 'fade4675', 0),
(16315, 'rohim32', 'sphillips@gmail.com', 'jakfor#2344A', '01648569632', 'Historical', 'Dhaka', '4a8de781', 0),
(39525, 'Sojib', 'sphutm.edu', 'A@321asdf', '01648569632', 'Lake', 'Dhaka', '66310c89', 0),
(58747, 'ABUJAFOR', 'abdulhadi.me.2010@gmail.com', '$2y$10$XJJN/bb8zf81Q/MRqUg0zuS0DKyATtxbhD60uCdKs7U', '0176760683', 'Sea Beach', 'Dhaka', '2d905ba1', 0),
(95118, 'jafor', 'abujahadi1@gmail.com', '123', '', 'Mountain', 'House-470/2/A,Flat # 6-B, Mirpur,Sher-E-Bangla Nag', '839003e3ca2f194081968fc9c8de7a', 1);
...
--
ALTER TABLE `product`
  MODIFY `tour_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
